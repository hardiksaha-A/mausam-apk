...
import { Home, CloudSun, Wind, Map as MapIcon, Cpu, ShieldAlert, LineChart, ListChecks, Settings } from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 shrink-0 border-r border-[var(--color-panel-border)] bg-[var(--color-bg-secondary)]/60 backdrop-blur-sm h-screen sticky top-0">
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1" aria-label={tr('Primary navigation', 'मुख्य नेविगेशन')}>
