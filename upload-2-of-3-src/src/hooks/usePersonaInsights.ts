 ...
 */
export function usePersonaInsights(): { insights: SmartInsight[]; forPersona: (p: Persona) => SmartInsight | null } {
  ...
  return useMemo(() => {
    ...
    return { insights, forPersona };
  }, [preferences.personas, preferences.commuteWindows, weather, airQuality, marine, pollen, location.latitude]);
}
