...
import { cond, compass, aqiAdvice, severity, ph } from '../i18n/dynamic';
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap mb-1">
              ...
              <span className="inline-flex items-center gap-1 text-sm text-[var(--color-text-muted)]">
                <TrendIcon size={12} style={{ color: trendColor }} /> {ph(insight.trend)}
              </span>
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-[var(--color-text-secondary)]">
                    {cond(weather.current.condition)} • {t('dashboard.feelsLike')} {formatTemp(weather.current.feelsLike, preferences.units)}
                  </p>
                </div>
              </div>
            ) : null}
