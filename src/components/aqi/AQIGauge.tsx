import { tr, aqiCat } from '../../i18n/dynamic';
...
export const AQIGauge: React.FC<AQIGaugeProps> = ({ aqi, category, size = 200 }) => {
  ...
  return (
    <div className="flex flex-col items-center" role="img" aria-label={`${tr('Air Quality Index', 'वायु गुणवत्ता सूचकांक')} ${aqi ?? tr('unavailable', 'उपलब्ध नहीं')}, ${aqiCat(category)}`}>
